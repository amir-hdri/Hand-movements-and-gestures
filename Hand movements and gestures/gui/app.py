...
from gui.data_manager import DataCollector
from gui.model_trainer import GestureTrainer
from gui.inference import GestureInference
from gesture_recognition.robot_interface import MockRobotController, PingPongController
...
class GestureApp(tk.Tk):
    def __init__(self):
        ...
        self.trainer = GestureTrainer(self.config)
        self.inference = GestureInference(self.config)
    ...
    def setup_inference_tab(self):
        ...
        modes = ["Mock"]
        try:
            # Check if pingpong is available
            import pingpong
        ...
        while self.is_running:
            ...
            if results and results.multi_hand_landmarks:
                ...
                if action:
                    ...
                    pass # Keep previous result or show nothing?
            else:
                try:
                     if self.result_queue.full():
                         self.result_queue.get_nowait()
